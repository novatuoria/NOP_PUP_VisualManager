...
- Advanced visual styles: Create classes for deeper visual styling (primarily layers between CMDIFrameWnd (and similar) and the user-inherited class for full non-client area support).
...
- Создать классы реализующие более глубокую проработку визуальных стилей (в основном это должны быть прослойки между CMDIFrameWnd (и иже с ними) и пользовательским классом наследником, для полноценного подхвата неклиентской области).
