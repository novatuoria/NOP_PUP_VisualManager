...
// NOP_PUP_VSMNGDoc.h: интерфейс класса CNOPPUPVSMNGDoc 
//
...
class CNOPPUPVSMNGDoc : public CDocument
{
protected: // создать только из сериализации
	CNOPPUPVSMNGDoc() noexcept;
	DECLARE_DYNCREATE(CNOPPUPVSMNGDoc)
