...
// NOP_PUP_VSMNG.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CNOPPUPVSMNGApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CNOPPUPVSMNGApp::OnAppAbout)
...
// Создание CNOPPUPVSMNGApp

CNOPPUPVSMNGApp::CNOPPUPVSMNGApp() noexcept
{
	...
	SetAppID(_T("NOPPUPVSMNG.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CNOPPUPVSMNGApp

CNOPPUPVSMNGApp theApp;


// Инициализация CNOPPUPVSMNGApp

BOOL CNOPPUPVSMNGApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_NOPPUPVSMNGTYPE,
		RUNTIME_CLASS(CNOPPUPVSMNGDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CNOPPUPVSMNGView));
	if (!pDocTemplate)
		return FALSE;
...
int CNOPPUPVSMNGApp::ExitInstance()
{
...
// Обработчики сообщений CNOPPUPVSMNGApp
...
void CNOPPUPVSMNGApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CNOPPUPVSMNGApp

void CNOPPUPVSMNGApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CNOPPUPVSMNGApp::LoadCustomState()
{
}

void CNOPPUPVSMNGApp::SaveCustomState()
{
}
